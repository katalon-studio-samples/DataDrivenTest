...
WebUI.setText(findTestObject('Login Page of Demo Application/input_username'), demo_username)

'Enter the value of password (From Internal Test Data)'
WebUI.setText(findTestObject('Login Page of Demo Application/input_password'), demo_password)
